...
//    func testBasicBsearch() {
//        let values = (1...10).map({$0})
//        let testData = [(-1, false), (0, false), (1, true), (5, true), (8, true), (10, true), (11, false), (100, false)]
...
//        }
//        testData.forEach({
//            if let (_, times) = bsearch(with: $0.0, from: values, comparator: comp) {
//                XCTAssert($0.1)
//                XCTAssert(Int(log2(Double(values.count))) + 2 > times)
//            } else {
//                XCTAssert(!$0.1)
//            }
//        })
...
//    }
    ...
    func testA() {
        let str = "abcdef<44&aa"
        print(str.escapeHTML)
    }
}
